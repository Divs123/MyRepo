(function (global, factory) {
    ...
    (factory((global.angular2-notification-bar = global.angular2-notification-bar || {}),global.ng.core,global.ng.common));
...
var NotificationBarService = (function () {
    ...
    /** @nocollapse */
    NotificationBarService.ctorParameters = [];
...
var NotificationBarComponent = (function () {
                    ...
                    animations: [
                        _angular_core.trigger('flyDown', [
                            ...
                            _angular_core.transition('void => *', [
                                ...
                                _angular_core.animate('600ms ease .2s 1 both')
                            ]),
                            _angular_core.transition('* => void', [
                                _angular_core.animate('200ms ease .2s 1 both', _angular_core.style({
                                    opacity: 0,
                                    transform: 'translateY(-100%)'
                                }))
                            ])
    ...
    /** @nocollapse */
    NotificationBarComponent.ctorParameters = [
